...
from nes2.services.migration import MigrationManager, MigrationRunner, MigrationStatus
...
"""
        ...
        click.echo(
            f"  4. Test your migration with: nes2 migrate run {migration_name} --dry-run"
        )
