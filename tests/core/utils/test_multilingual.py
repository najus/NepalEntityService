...
from nes.core.utils.multilingual import (
...
class TestCrossLanguageNameMatching:
    ...
    def test_match_exact_names_same_language(self):
        ...
        assert (
            match_names_cross_language("Ram Chandra Poudel", "Ram Chandra Poudel")
            is True
        )
...
class TestPhoneticSearchNepali:
    ...
    def test_phonetic_search_exact_match(self):
        ...
        candidates = ["राम चन्द्र पौडेल", "पुष्पकमल दाहाल", "शेरबहादुर देउवा"]
    ...
    def test_phonetic_search_no_matches(self):
        ...
        candidates = ["राम चन्द्र पौडेल", "पुष्पकमल दाहाल"]
